...
public enum CourseCode implements ResultCode {
    ...
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31104,"课程媒体计划为空！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31005,"课程媒体计划出错！"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31103,"创建elasticsearch索引错误！");
